...
class authPage {
  ...
  elementChecking() {
    this.visitLoginPage();
    cy.softAssert(cy.get("img").should("be.visible").click(), "Image clicked");
    cy.softAssert(
      cy.get(".text-2xl").should("contain", "Log in sekarang"),
      "Login text found"
    );
    cy.softAssert(
      cy.get('input#keyword[placeholder="Masukan email anda"]'),
      "Email input visible"
    );
    cy.softAssert(
      cy
        .get('input#password[placeholder="Masukkan Password"]')
        .should("be.visible"),
      "Password input visible"
    );
    cy.softAssert(
      cy.get('button[data-cy="login-button-sign-in"]').should("be.visible"),
      "Login button visible"
    );
    cy.softAssert(
      cy.get('a[href="/reset-password"] > p').should("be.visible"),
      "Reset password link visible"
    );
    cy.softAssert(cy.get('a[href="/register"] > p'), "Register link visible");
  }
  ...
  validate_dual_Login() {
    cy.softAssert(
      cy
        .xpath(
          "/html[1]/body[1]/main[1]/main[1]/section[1]/div[1]/div[2]/div[1]/div[1]/p[2]"
        )
        .click(),
      "click profile failed"
    );
    this.doLogout();
  }
  ...
  loginValidEmail() {
    ...
    if (baseUrl === "https://dev.satuinbox.com") {
      if (loginType === "chickentester") {
        cy.softAssert(
          cy.login_chickentester_email("myUsername", "myPassword"),
          "login dev chickentester)"
        );
        return;
      }
      ...
      if (loginType === "messagelogsatu") {
        cy.softAssert(
          cy.login_messagelogsatu("myUsername", "myPassword"),
          "login dev messagelogsatu)"
        );
        return;
      }
      if (loginType === "messagelogdua") {
        cy.softAssert(
          cy.login_messagelogdua("myUsername", "myPassword"),
          "login dev messagelogdua)"
        );
        return;
      }
      return;
    ...
    if (baseUrl === "https://staging.satuinbox.com") {
      if (loginType === "chickentester") {
        cy.softAssert(
          cy.login_staging_by_email("myUsername", "myPassword"),
          "login staging "
        );
        return;
      }
  ...
  //       cy.softAssert(
  //         cy.login_prod_by_username_prodtestingjuli("myUsername", "myPassword"),
  //         "login prod "
  //       );
  //       return;
  //     }
  ...
  //     if (loginType === "chickentester") {
  //       cy.softAssert(
  //         cy.login_chickentester_username("myUsername", "myPassword"),
  //         "login dev chicken tester"
  //       );
  //       return;
  //     }
  //     if (loginType === "goddummy") {
  ...
  //       return;
  //     }
  //     if (loginType === "goddummysa") {
  //       cy.softAssert(
  //         cy.login_goddummysa("myUsername", "myPassword"),
  //         "login dev god dummy super"
  //       );
  //       return;
  //     }
  //     return;
  ...
  //     if (loginType === "local") {
  //       cy.login_localhost("myUsername", "myPassword");
  //       return;
  //     }
  //   }
  //   if (baseUrl === "https://staging.satuinbox.com") {
  ...
  //       cy.softAssert(
  //         cy.login_chickentester_username("myUsername", "myPassword"),
  //         "login chickentester staging "
  //       );
  //       return;
  //     }
  //     // cy.softAssert(
  //     //   cy.login_staging("myUsername", "myPassword"),
  //     //   "login staging "
  //     // );
  //     return;
  //   }
  //   if (baseUrl === "https://niagakara.satuinbox.com") {
  //     if (loginType === "niagakara") {
  //       cy.softAssert(
  //         cy.login_niagakara("myUsername", "myPassword"),
  //         "login niagakara "
  //       );
  //       return;
  //     }
  ...
  login_testhandoverDev() {
    cy.visit("/login");
    cy.wait(500);
    cy.softAssert(
      cy.login_testhandover("myUsername", "myPassword"),
      "login testhandover dev for bulk action single handover"
    );
  }
  ...
  loginAsAdmin() {
    ...
    if (baseUrl === "https://sap.satuinbox.com") {
      ...
      cy.softAssert(
        cy.login_as_admin("myUsername", "myPassword"),
        "login dev "
      );
      // cy.softAssert(cy.login_dev_by_username('myUsername','myPassword'),'login dev ');
    ...
    cy.softAssert(cy.dashboardNav(), "Login Success, directed to Dashboard");
  }

  login_SAP_superAdmin() {
    cy.visit("/login");
    if (baseUrl === "https://sap.satuinbox.com") {
      cy.softAssert(
        cy.login_prod_by_username("myUsername", "myPassword"),
      ...
      cy.softAssert(
        cy.login_SAP_superAdmin("myUsername", "myPassword"),
        "login super Admin SAP "
      );
      // cy.softAssert(cy.login_dev_by_username('myUsername','myPassword'),'login dev ');
    } else if (baseUrl === "http://localhost:3000") {
      cy.login_localhost("myUsername", "myPassword");
  ...
  //   } else if (baseUrl === "https://dev.satuinbox.com") {
  //     cy.softAssert(
  //       cy.loginBikiniBottom_owner("myUsername", "myPassword"),
  //       "login super Admin SAP "
  //     );
  //     // cy.softAssert(cy.login_dev_by_username('myUsername','myPassword'),'login dev ');
  //   } else if (baseUrl === "http://localhost:3000") {
  ...
  //   } else if (baseUrl === "https://dev.satuinbox.com") {
  //     cy.softAssert(
  //       cy.loginBikiniBottom_admin("myUsername", "myPassword"),
  //       "login super Admin SAP "
  //     );
  //     // cy.softAssert(cy.login_dev_by_username('myUsername','myPassword'),'login dev ');
  //   } else if (baseUrl === "http://localhost:3000") {
  ...
  //   } else if (baseUrl === "https://dev.satuinbox.com") {
  //     cy.softAssert(
  //       cy.loginBikiniBottom_agent("myUsername", "myPassword"),
  //       "login super Admin SAP "
  //     );
  //     // cy.softAssert(cy.login_dev_by_username('myUsername','myPassword'),'login dev ');
  //   } else if (baseUrl === "http://localhost:3000") {
  ...
  //   cy.wait(2000);
  //   cy.softAssert(
  //     cy.headLabelInbox().contains("Inbox"),
  //     "Login Success, directed to Inbox"
  //   );
  // }
  ...
  //   } else if (baseUrl === "https://dev.satuinbox.com") {
  //     cy.softAssert(
  //       cy.loginKentang_owner("myUsername", "myPassword"),
  //       "login owner"
  //     );
  //     // cy.softAssert(cy.login_dev_by_username('myUsername','myPassword'),'login dev ');
  //   } else if (baseUrl === "http://localhost:3000") {
  ...
  //   } else if (baseUrl === "https://dev.satuinbox.com") {
  //     cy.softAssert(
  //       cy.loginKentang_admin("myUsername", "myPassword"),
  //       "login child user admin"
  //     );
  //     // cy.softAssert(cy.login_dev_by_username('myUsername','myPassword'),'login dev ');
  //   } else if (baseUrl === "http://localhost:3000") {
  //     cy.login_localhost("myUsername", "myPassword");
  ...
  //   } else if (baseUrl === "https://dev.satuinbox.com") {
  //     cy.softAssert(
  //       cy.loginKentang_agent("myUsername", "myPassword"),
  //       "login child user agent "
  //     );
  //     // cy.softAssert(cy.login_dev_by_username('myUsername','myPassword'),'login dev ');
  //   } else if (baseUrl === "http://localhost:3000") {
  //     cy.login_localhost("myUsername", "myPassword");
  ...
  loginInvalidEmail() {
    cy.visit("/login");
    cy.login_invalid_email("myUsername", "myPassword");
    cy.xpath(
      // "/html[1]/body[1]/main[1]/main[1]/section[1]/div[1]/div[2]/form[1]/div[4]/p[1]"
      "/html[1]/body[1]/main[1]/main[1]/section[1]/div[1]/div[2]/div[1]/div[1]"
    )
  ...
  loginInvalidPassword() {
    cy.visit("/login");
    cy.login_invalid_password("myUsername", "myPassword");
    cy.wait(500);
    cy.xpath(
      // "/html[1]/body[1]/main[1]/main[1]/section[1]/div[1]/div[2]/form[1]/div[4]/p[1]"
      "/html[1]/body[1]/main[1]/main[1]/section[1]/div[1]/div[2]/div[1]/div[1]"
  ...
  loginBlankemail() {
    cy.visit("/login");
    cy.login_blank_email("myUsername", "myPassword");
    // cy.get("input#keyword:invalid");
  ...
  loginBlankPassword() {
    cy.visit("/login");
    cy.login_blank_password("myUsername", "myPassword");
  ...
  spamLogin(user) {
    // userDataSpam.forEach((key) =>{
    //     cy.visit('/login');
    //     cy.viewport(1366, 768);
    //     cy.get('#keyword').type(key.keyword);
    //     cy.get('#password').type(key.password);
    //     cy.get('.bg-primary').click();
    // })
    cy.visit("/login");
    cy.viewport(1366, 768);
    cy.get("#keyword").type(user.keyword);
