...
- Name: e2e\auth\login.spec.js >> Auth Login Tests >> login with empty fields
- Location: playwright\tests\e2e\auth\login.spec.js:47:3
...
Locator:  getByTestId('Keyword-Input')
Expected: "true"
Received: ""
Timeout:  5000ms
...
Call log:
  ...
  - waiting for getByTestId('Keyword-Input')
    8 × locator resolved to <input type="text" id="username" name="usernameEmail" data-cy="Keyword-Input" placeholder="Masukan username atau email" class="flex h-10 w-full rounded-md border py-2 text-sm ring-offset-0 file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50 disabled:bg-slate-100 disabled:text-slate-400 border-red-600 !bg-red-50 focus-visible:border-red-600 pl-10"/>
    ...
    - generic [ref=e4]:
      ...
      - generic [ref=e10]:
        - generic [ref=e11]:
          - generic [ref=e12]:
            - img [ref=e14]
            - textbox "Masukan username atau email" [active] [ref=e17]
          - paragraph [ref=e18]: Username atau Email wajib diisi
        - generic [ref=e19]:
          - generic [ref=e20]:
            - img [ref=e22]
            - textbox "Masukan password" [ref=e29]
            - button "Tampilkan Password" [ref=e30] [cursor=pointer]:
              - img [ref=e31]
          - paragraph [ref=e34]: Password minimal 8 karakter
        - generic [ref=e35]:
          - checkbox [ref=e36] [cursor=pointer]
          - checkbox
          - paragraph [ref=e37]: Ingat saya
        - button "Log in" [ref=e38] [cursor=pointer]
        - generic [ref=e39]:
          - link "Tidak bisa login?" [ref=e40] [cursor=pointer]:
            - /url: /reset-password
            - paragraph [ref=e41]: Tidak bisa login?
          - img [ref=e42]
          - link "Buat akun" [ref=e44] [cursor=pointer]:
            - /url: /register
            - paragraph [ref=e45]: Buat akun
  - alert [ref=e46]
```
