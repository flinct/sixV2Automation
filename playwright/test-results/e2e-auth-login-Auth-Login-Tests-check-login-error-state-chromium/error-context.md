...
- Name: e2e\auth\login.spec.js >> Auth Login Tests >> check login error state
- Location: playwright\tests\e2e\auth\login.spec.js:30:3
  ...
  - main [ref=e2]:
    - generic [ref=e4]:
      ...
      - generic [ref=e10]:
        ...
        - generic [ref=e18]:
          - img [ref=e20]
          - textbox "Masukan username atau email" [ref=e23]: invalid-user
        - generic [ref=e25]:
          - img [ref=e27]
          - textbox "Masukan password" [ref=e34]: wrong-pass
