...
const testAccounts = {
  ...
  testerdummyagent1: account(
    "E2E_PROD_TESTERDUMMYAGENT_USER",
    "E2E_PROD_TESTERDUMMYAGENT_PASSWORD",
    "agent",
    ["dev", "prod"],
    "prod-tester",
  ),
  testerdummyagent2: account(
    "E2E_PROD_TESTERDUMMYAGENT_2_USER",
    "E2E_PROD_TESTERDUMMYAGENT_2_PASSWORD",
    "agent",
    ["dev", "prod"],
    "prod-tester",
  ),
  testerdummyagent3: account(
    "E2E_PROD_TESTERDUMMYAGENT_3_USER",
    "E2E_PROD_TESTERDUMMYAGENT_3_PASSWORD",
    "agent",
    ["dev", "prod"],
    "prod-tester",
  ),
  testerdummyagent4: account(
    "E2E_PROD_TESTERDUMMYAGENT_4_USER",
    "E2E_PROD_TESTERDUMMYAGENT_4_PASSWORD",
    "agent",
    ["dev", "prod"],
    "prod-tester",
  ),
